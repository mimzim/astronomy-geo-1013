...
{    
    var t = document.getElementById("as");
    
    t.setAttribute("title", "Tycho Brahe");
...
function printNicolausCopernicus()
{
    ...
    t.setAttribute("title", "Nicolaus Copernicus");
...

{
    ...
    t.setAttribute("title", "Galileo Galilei");
...
function printJohannesKepler()
{
    ...
    t.setAttribute("title", "Johannes Kepler");
...
function printClaudiusPtolemy()
{
    ...
    t.setAttribute("title", "Claudius Ptolemy");
    t.setAttribute("alt", "Claudius Ptolemy");
...
{    
    ...
    t.setAttribute("title", "Sir Isaac Newton");
    t.setAttribute("alt", "Sir Isaac Newton");
    t.setAttribute("src", "images/newton.jpg");
...
{    
    ...
    t.setAttribute("title", "Aristotle");
    t.setAttribute("alt", "Aristotle");
    t.setAttribute("src", "images/aristotle.jpg");
...
{    
    ...
    t.setAttribute("title", "Geocentricity");
    t.setAttribute("alt", "Geocentricity");
    t.setAttribute("src", "images/geocentric.jpg");
...
{    
    ...
    t.setAttribute("title", "Retrograde Motion");
    t.setAttribute("alt", "Retrograde Motion");
...
{    
    ...
    t.setAttribute("title", "Stellar Parallax");
    t.setAttribute("alt", "Stellar Parallax");
    t.setAttribute("src", "images/stellar-paralax.png");
...
{    
    ...
    t.setAttribute("title", "Kepler's Third Law");
    t.setAttribute("alt", "Kepler's Third Law");
    t.setAttribute("src", "images/kepler-law-3.png");
